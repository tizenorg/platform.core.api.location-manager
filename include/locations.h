 ...
 * @details Calling this function starts location tracking, which lasts for @a batch_period seconds.
			The location is read every @a batch_interval seconds. When the reading is completed,
			the callback set with location_manager_set_location_batch_cb() is called.
