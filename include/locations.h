...
#if 0
/**
 * @brief Checks whether the mock location is enabled or not on setting.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/location
 * @param[out] enable		The result value of mock location
 * @return 0 on success, otherwise a negative error value
 * @retval #LOCATIONS_ERROR_NONE Successful
 * @retval #LOCATIONS_ERROR_INVALID_PARAMETER	Invalid parameter
 * @retval #LOCATIONS_ERROR_NOT_SUPPORTED	Not supported
 ...
 * @see location_manager_unset_setting_changed_cb()
 */
int location_manager_is_test_location_enabled(bool *enable);

/**
 * @brief Enable mock location for the given location method.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/location
 * @param[in] method		The value to set
 * @param[in] enable		The value to set
 * @return 0 on success, otherwise a negative error value
 * @retval #LOCATIONS_ERROR_NONE Successful
 * @retval #LOCATIONS_ERROR_INCORRECT_METHOD Incorrect method
 ...
 * @see location_manager_create()
 */
//int location_add_test_provider(const LocationMethod method, const int enable);
int location_manager_set_test_location_method(location_method_e method, const bool enable);
#endif
 ...
 * @param[in] climb		The climb (km/h)
 * @param[in] direction	The direction, degrees from the north
 * @param[in] speed		The speed (km/h)
 * @param[in] level		The accuracy level
 ...
 * @pre The location service state must be #LOCATIONS_SERVICE_ENABLED with location_manager_start()
 */
int location_manager_set_mock_location(location_manager_h manager, double altitude, double latitude, double longitude, double climb, double direction, double speed, location_accuracy_level_e level, double horizontal, double vertical);
