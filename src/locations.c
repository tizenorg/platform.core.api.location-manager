...
EXPORT_API int location_manager_set_mock_location(location_manager_h manager, double latitude, double longitude, double altitude,
	double speed, double direction, double accuracy)
{
	LOCATIONS_NOT_SUPPORTED_CHECK(__is_location_supported());
	LOCATIONS_NULL_ARG_CHECK(manager);
